...
<head>
    ...
    <title>COCK Admin - Multipurpose Bootstrap Dashboard Template </title>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="{{route('category.index')}}" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="authentication" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('addsale')}}"> Add Sales </a>
                            </li>
                            <li>
                                <a href="{{route('datefilter')}}" class="two-dates" data-toggle="modal"
                    ...
                    <li class="menu">
                        <a href="{{URL('payment')}}" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu">
                        <a href="{{URL('receive')}}" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="pages" data-parent="#accordionExample">
                            <li>
                                <a href="{{URL('general_datefilter')}}" class="two-dates" data-toggle="modal"
                                data-target="#date_modal"> General </a>
                            </li>
                            <li>
                                <a href="{{URL('showcredit')}}" class="two-dates" data-toggle="modal"
                                data-target="#date_modal"> Payment </a>
                            </li>
                            <li>
                                <a href="{{route('showdebit')}}" class="two-dates" data-toggle="modal"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('monthly_sale')}}" class="months-list" data-toggle="modal"
                                data-target="#date_modal"> Sale </a>
                            </li>
                            <li>
                                <a href="{{route('monthly_payment')}}" class="months-list" data-toggle="modal"
                                data-target="#date_modal"> Payment </a>
                            </li>

                            <li>
                                <a href="{{route('monthly_receive')}}" class="months-list" data-toggle="modal"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="datatables" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('yearly_sale')}}" class="years-list" data-toggle="modal"
                                data-target="#date_modal"> Sale </a>
                            </li>
                            <li>
                                <a href="{{route('yearly_payment')}}" class="years-list" data-toggle="modal"
                                data-target="#date_modal"> Payment </a>
                            </li>
                            <li>
                                <a href="{{route('yearly_receive')}}" class="years-list" data-toggle="modal"
                                data-target="#date_modal"> Receiving </a>
                            </li>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="dates" class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" value={{Carbon\Carbon::now()->startOfMonth()}} class="form-control" name="start">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">End</label>
                                <input type="date" value={{Carbon\Carbon::now()}} class="form-control" name="end">
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.buttons-list').click(function (e) {
                ...
                $('#select_list3').show();
                let id = this.id;
                $('#paypal').attr('href', "http://epos.tritec.online/paypal"+'/'+id);
                $('#card').attr('href', "http://epos.tritec.online/paypal"+'/'+id);
                $('#cash').attr('href', "http://epos.tritec.online/cash"+'/'+id);
            });
